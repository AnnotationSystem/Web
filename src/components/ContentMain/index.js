...
const HomeworkPage = LoadableComponent(()=>import('../../routes/General/HomeworkPage/index'))
const HomeworkCreate = LoadableComponent(()=>import('../../routes/General/HomeworkPage/HomeworkCreate/index'))
const HomeworkDetail = LoadableComponent(()=>import('../../routes/General/HomeworkPage/HomeworkDetail/index'))
const HomeworkResult = LoadableComponent(()=>import('../../routes/General/HomeworkPage/HomeworkDetail/HomeworkResult/index'))
    ...
    return (
      <div style={{padding: 16, position: 'relative'}}>
        <Switch>
          ...
          <PrivateRoute exact path='/home/general/homework' component={HomeworkPage}/>
          <PrivateRoute exact path='/home/general/homework/create' component={HomeworkCreate}/>
          <PrivateRoute exact path='/home/general/homework/:hwid' component={HomeworkDetail}/>
          <PrivateRoute exact path='/home/general/homework/:hwid/:hwrsid' component={HomeworkResult}/>
